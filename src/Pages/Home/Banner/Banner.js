    ...
    return (
        <div className='banner-main pt-5'>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 text-start text-white d-flex align-items-center">
                ...
                <span className="text-danger ms-3">
                    ...
                    <a target="_blank" href="https://drive.google.com/file/d/1QvFJD2QRRnXDbw9GyfV2A7GhUXxxemdC/view?usp=sharing"><Button>Dawnload Resume</Button></a>
                        </div>
                    </div>
                    <div className="col-lg-6 d-flex align-items-center">
                        ...
                        <img className="image-fluid" src={raihan} alt="" />
                        </div>
                    </div>
                </div>
            </div>
